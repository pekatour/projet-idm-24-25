...
/**
 * This is the item provider adapter for a {@link calcul.Entree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntreeItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entree_valeur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entree_valeur_feature", "_UI_Entree_type"),
				 CalculPackage.Literals.ENTREE__VALEUR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Entree)object).getValeur();
