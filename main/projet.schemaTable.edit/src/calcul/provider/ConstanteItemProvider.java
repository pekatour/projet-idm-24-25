...
/**
 * This is the item provider adapter for a {@link calcul.Constante} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstanteItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constante_valeur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constante_valeur_feature", "_UI_Constante_type"),
				 CalculPackage.Literals.CONSTANTE__VALEUR,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constante.class)) {
			case CalculPackage.CONSTANTE__VALEUR:
