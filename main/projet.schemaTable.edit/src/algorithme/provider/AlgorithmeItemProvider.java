	...
	protected void addRessourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Algorithme_ressource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_ressource_feature", "_UI_Algorithme_type"),
				 AlgorithmePackage.Literals.ALGORITHME__RESSOURCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlgorithmePackage.Literals.ALGORITHME__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLangagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Algorithme_langage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_langage_feature", "_UI_Algorithme_type"),
				 AlgorithmePackage.Literals.ALGORITHME__LANGAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
