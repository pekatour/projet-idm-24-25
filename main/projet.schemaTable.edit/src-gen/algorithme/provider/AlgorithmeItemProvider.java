...
public class AlgorithmeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Algorithme_nom_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_nom_feature",
								"_UI_Algorithme_type"),
						AlgorithmePackage.Literals.ALGORITHME__NOM, true, false, false,
	...
	protected void addRessourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Algorithme_ressource_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_ressource_feature",
								"_UI_Algorithme_type"),
						AlgorithmePackage.Literals.ALGORITHME__RESSOURCE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Algorithme_documentation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_documentation_feature",
								"_UI_Algorithme_type"),
						AlgorithmePackage.Literals.ALGORITHME__DOCUMENTATION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Langage feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLangagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Algorithme_langage_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_langage_feature",
								"_UI_Algorithme_type"),
						AlgorithmePackage.Literals.ALGORITHME__LANGAGE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSortiePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Algorithme_sortie_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_sortie_feature",
								"_UI_Algorithme_type"),
						AlgorithmePackage.Literals.ALGORITHME__SORTIE, true, false, true, null, null, null));
	}
	...
	protected void addEntreePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Algorithme_entree_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_entree_feature",
								"_UI_Algorithme_type"),
						AlgorithmePackage.Literals.ALGORITHME__ENTREE, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AlgorithmePackage.Literals.ALGORITHME__ENTREE,
