...
public class SortieItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addAlgorithmePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Sortie_algorithme_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Sortie_algorithme_feature",
								"_UI_Sortie_type"),
						AlgorithmePackage.Literals.SORTIE__ALGORITHME, true, false, true, null, null, null));
	}
