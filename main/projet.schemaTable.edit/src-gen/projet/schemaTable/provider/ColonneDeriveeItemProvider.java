...
public class ColonneDeriveeItemProvider extends ColonneItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchemaTablePackage.Literals.COLONNE_DERIVEE__ALGORITHME);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ColonneDerivee.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SchemaTablePackage.Literals.COLONNE_DERIVEE__ALGORITHME,
