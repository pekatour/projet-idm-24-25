...
/**
 * This is the item provider adapter for a {@link projet.schemaTable.ColonneEtrangere} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColonneEtrangereItemProvider extends ColonneItemProvider {
	...
	protected void addTableEtrangerePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ColonneEtrangere_tableEtrangere_feature",
						"_UI_ColonneEtrangere_type"),
				SchemaTablePackage.Literals.COLONNE_ETRANGERE__TABLE_ETRANGERE, true, false, true, null, null, null));
	}
	...
	protected void addIdColonneTableEtrangerePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ColonneEtrangere_idColonneTableEtrangere_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_ColonneEtrangere_idColonneTableEtrangere_feature", "_UI_ColonneEtrangere_type"),
						SchemaTablePackage.Literals.COLONNE_ETRANGERE__ID_COLONNE_TABLE_ETRANGERE, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ColonneEtrangere_type")
