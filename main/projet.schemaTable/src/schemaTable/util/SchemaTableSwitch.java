...
public class SchemaTableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SchemaTablePackage.COLONNE_IDENTIFIANTS: {
				ColonneIdentifiants colonneIdentifiants = (ColonneIdentifiants)theEObject;
				T result = caseColonneIdentifiants(colonneIdentifiants);
				if (result == null) result = caseColonne(colonneIdentifiants);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Colonne Identifiants</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Colonne Identifiants</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColonneIdentifiants(ColonneIdentifiants object) {
		return null;
	}
