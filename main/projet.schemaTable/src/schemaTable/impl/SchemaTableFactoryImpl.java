...
public class SchemaTableFactoryImpl extends EFactoryImpl implements SchemaTableFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SchemaTablePackage.TABLE: return createTable();
			case SchemaTablePackage.COLONNE: return createColonne();
			case SchemaTablePackage.COLONNE_DERIVEE: return createColonneDerivee();
			case SchemaTablePackage.COLONNE_ETRANGERE: return createColonneEtrangere();
			case SchemaTablePackage.COLONNE_IDENTIFIANTS: return createColonneIdentifiants();
			default:
