 ...
 * </p>
 * <ul>
 *   <li>{@link schemaTable.impl.ColonneDeriveeImpl#getAlgorithme <em>Algorithme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColonneDeriveeImpl extends ColonneImpl implements ColonneDerivee {
	...
	public NotificationChain basicSetAlgorithme(Algorithme newAlgorithme, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaTablePackage.COLONNE_DERIVEE__ALGORITHME, oldAlgorithme, newAlgorithme);
	...
	public void setAlgorithme(Algorithme newAlgorithme) {
		if (newAlgorithme != algorithme) {
			...
			if (algorithme != null)
				msgs = ((InternalEObject)algorithme).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaTablePackage.COLONNE_DERIVEE__ALGORITHME, null, msgs);
			if (newAlgorithme != null)
				msgs = ((InternalEObject)newAlgorithme).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaTablePackage.COLONNE_DERIVEE__ALGORITHME, null, msgs);
			msgs = basicSetAlgorithme(newAlgorithme, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaTablePackage.COLONNE_DERIVEE__ALGORITHME, newAlgorithme, newAlgorithme));
	}
