 ...
 * </p>
 * <ul>
 *   <li>{@link schemaTable.impl.ColonneEtrangereImpl#getTableEtrangere <em>Table Etrangere</em>}</li>
 *   <li>{@link schemaTable.impl.ColonneEtrangereImpl#getIdColonneTableEtrangere <em>Id Colonne Table Etrangere</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColonneEtrangereImpl extends ColonneImpl implements ColonneEtrangere {
		...
		if (tableEtrangere != null && tableEtrangere.eIsProxy()) {
			...
			if (tableEtrangere != oldTableEtrangere) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchemaTablePackage.COLONNE_ETRANGERE__TABLE_ETRANGERE, oldTableEtrangere, tableEtrangere));
			}
		}
	...
	public void setTableEtrangere(Table newTableEtrangere) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaTablePackage.COLONNE_ETRANGERE__TABLE_ETRANGERE, oldTableEtrangere, tableEtrangere));
	}
	...
	public void setIdColonneTableEtrangere(String newIdColonneTableEtrangere) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaTablePackage.COLONNE_ETRANGERE__ID_COLONNE_TABLE_ETRANGERE, oldIdColonneTableEtrangere, idColonneTableEtrangere));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchemaTablePackage.COLONNE_ETRANGERE__TABLE_ETRANGERE:
				if (resolve) return getTableEtrangere();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SchemaTablePackage.COLONNE_ETRANGERE__ID_COLONNE_TABLE_ETRANGERE:
				return ID_COLONNE_TABLE_ETRANGERE_EDEFAULT == null ? idColonneTableEtrangere != null : !ID_COLONNE_TABLE_ETRANGERE_EDEFAULT.equals(idColonneTableEtrangere);
		}
