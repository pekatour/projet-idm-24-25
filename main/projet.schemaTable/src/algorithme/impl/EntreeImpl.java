...
public class EntreeImpl extends MinimalEObjectImpl.Container implements Entree {
	...
	public Algorithme getAlgorithme() {
		if (eContainerFeatureID() != AlgorithmePackage.ENTREE__ALGORITHME) return null;
	...
	public void setAlgorithme(Algorithme newAlgorithme) {
		if (newAlgorithme != eInternalContainer() || (eContainerFeatureID() != AlgorithmePackage.ENTREE__ALGORITHME && newAlgorithme != null)) {
			...
			if (newAlgorithme != null)
				msgs = ((InternalEObject)newAlgorithme).eInverseAdd(this, AlgorithmePackage.ALGORITHME__ENTREE, Algorithme.class, msgs);
			msgs = basicSetAlgorithme(newAlgorithme, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmePackage.ENTREE__ALGORITHME, newAlgorithme, newAlgorithme));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AlgorithmePackage.ENTREE__ALGORITHME:
				return eInternalContainer().eInverseRemove(this, AlgorithmePackage.ALGORITHME__ENTREE, Algorithme.class, msgs);
		}
