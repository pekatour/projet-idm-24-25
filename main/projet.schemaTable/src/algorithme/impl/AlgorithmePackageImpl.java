...
public class AlgorithmePackageImpl extends EPackageImpl implements AlgorithmePackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAlgorithme_Nom(), ecorePackage.getEString(), "nom", null, 1, 1, Algorithme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
