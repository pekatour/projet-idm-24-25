...
public class AlgorithmeImpl extends MinimalEObjectImpl.Container implements Algorithme {
	...
	public void setRessource(String newRessource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmePackage.ALGORITHME__RESSOURCE, oldRessource,
					ressource));
	}
	...
	public void setLangage(Langage newLangage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmePackage.ALGORITHME__LANGAGE, oldLangage,
					langage));
	}
		...
		if (newSortie != sortie) {
			...
			if (sortie != null)
				msgs = ((InternalEObject) sortie).eInverseRemove(this, AlgorithmePackage.SORTIE__ALGORITHME,
						Sortie.class, msgs);
			if (newSortie != null)
				msgs = ((InternalEObject) newSortie).eInverseAdd(this, AlgorithmePackage.SORTIE__ALGORITHME,
						Sortie.class, msgs);
