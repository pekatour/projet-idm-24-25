...
/**
 * This is the item provider adapter for a {@link projet.schemaTable.ColonneDerivee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColonneDeriveeItemProvider extends ColonneItemProvider {
	...
	protected void addAlgorithmePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ColonneDerivee_algorithme_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ColonneDerivee_algorithme_feature",
								"_UI_ColonneDerivee_type"),
						SchemaTablePackage.Literals.COLONNE_DERIVEE__ALGORITHME, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ColonneDerivee_type")
